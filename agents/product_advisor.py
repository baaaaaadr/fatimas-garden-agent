...
product_advisor = LlmAgent(
    ...
    instruction=(
        ...
        "assume or guess stock. If the best-fit product for the concern is out of stock, FIRST say "
        "you would normally recommend it but it is currently out of stock, THEN recommend an in-stock "
        "alternative (e.g. \"I would usually recommend Shea Butter for very dry skin, but it is "
        "currently out of stock, so I recommend Argan Oil instead\").\n"
